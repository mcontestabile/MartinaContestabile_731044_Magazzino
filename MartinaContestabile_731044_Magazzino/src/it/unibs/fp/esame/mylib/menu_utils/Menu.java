...
import it.unibs.fp.esame.mylib.utilities.DataInput;
import java.util.TreeMap;

/**
 * Customizable console {@code Handler}.
 *
...
public class Menu implements Runnable {
    ...
    /**
     * Constructs a new {@code Handler} with input {@code Items}.
     *
    ...
    /**
     * Starts the execution of {@code Handler}.
     */
    @Override
    public void run() {
        generateFrameLength();
